...
downloadBinrayFile() {
    ...
    latestURL=$(curl -s https://api.github.com/repos/OwO-Network/nexttrace-enhanced/releases/latest | grep -i "browser_download_url.*${osDistribution}.*${archParam}" | awk -F '"' '{print $4}')
